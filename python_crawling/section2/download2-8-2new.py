...
savePath ="/Users/sangsoohan/Documents/Programing_Project/Project_Moneyball/python_crawling/section2/inf_img/"
...
for i,e in enumerate(recommand,1):
    ...
    fullfilename = os.path.join(savePath, savePath+'img_'+str(i)+'.jpg')
    time.sleep(0.5)
